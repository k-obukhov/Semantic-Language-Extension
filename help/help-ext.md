...
*   `SL: Show examples workspace` — Открывает в новом окне рабочее пространство с примерами программ, поставляемое вместе с компилятором языка SLang
*   `SL: Show language help` — Вывод краткой справки по языку
*   `SL: Show standard lib help` — Вывод краткой справки по стандартной библиотеке
